...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableListElement : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            _reorderableList.OnElementStartGrapped?.Invoke(new ReorderableList.ReorderableListEventStruct
            {
                DroppedObject = _draggingObject.gameObject,
                IsAClone = _reorderableList.CloneDraggedObject,
                SourceObject = _reorderableList.CloneDraggedObject ? gameObject : _draggingObject.gameObject,
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            //Debug.Log("target display - " + canvas.targetDisplay);
            Vector3 worldPoint;
            //Debug.Log(eventData.position);

            //var camera = MonitorSettingsHandler.instance.Camera_main;

            //Debug.Log(canvas.renderMode != RenderMode.ScreenSpaceOverlay);
            
            

            //RectTransformUtility.ScreenPointToWorldPointInRectangle(canvas.GetComponent<RectTransform>(), eventData.position,
            //    canvas.renderMode != RenderMode.ScreenSpaceOverlay ? camera : null, out worldPoint);
            ...
            // Костыль пзц
            // TODO: Нужно сделать, но это сложно
#if !UNITY_EDITOR
            //if (MonitorSettingsHandler.instance.displays[0].targetMonitor > 0)
            //{
            //    worldPoint -= new Vector3(Screen.width, 0, 0);
            //}
            ////////////////////////////////////////////
#endif
            ...
            //if (canvas.worldCamera == null) Debug.Log("world cam = null");
            //else Debug.Log("world camera - " + canvas.worldCamera.targetDisplay);
